	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 appendResult18 = (float4(( ( length( input.ase_texcoord2.xyz ) - temp_output_14_0 ) / ( _RingSize - temp_output_14_0 ) ) , 0.5 , 0.0 , 0.0));
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_14_0 = ( _RingOffset + 1.0 );
				float4 appendResult18 = (float4(( ( length( input.ase_texcoord.xyz ) - temp_output_14_0 ) / ( _RingSize - temp_output_14_0 ) ) , 0.5 , 0.0 , 0.0));
				float4 tex2DNode1 = tex2D( _DetailMap, appendResult18.xy );
				float temp_output_121_0 = saturate( ( tex2DNode1.a * _Clip ) );
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;4;-2004.199,-333.6001;Float;False;Property;_RingOffset;Ring Offset;2;0;Create;True;0;0;0;False;0;False;0;7.89;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;3;-1841.2,-213.6001;Float;False;Property;_RingSize;Ring Size;1;0;Create;True;0;0;0;False;0;False;0;5.99;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C753763277CE957B993A66260D8BA0D738AEFBB3